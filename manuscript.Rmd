...
Understanding the communication skills among the adolescents is vital as it is considered as the "key skill" in the education [@thurlow2001talkin]. To promote better understanding of subject contents assessing the communication skill among adolescents is highly required. For this purpose "Communication Skill" sub-skill set [@barkman2002four]  was developed in 2002 as a part of The  National  On-line  Youth  Life  Skills  Evaluation System [@mincemoyer2005measuring] and since then it has been extensively used .

# Study 1: Translations and Factor Structure

Our first study had two objectives. First, we translated the English communication scale to Bangla language. Second, to identified the latent structure of the Bangla Communication Scale (BCS) using Exploratory Factor Analysis (EFA)
