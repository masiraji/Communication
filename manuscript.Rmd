...
This study had fourth objectives. First, we confirmed the one factor solution of our scale obtained in Study-1. Second, to gather convergent validity evidence of BCS. For this, we calculated the bivariate correlation among the scores of Bangla Communication Scale and Bangla Hopeless Scale. Third, we establised gender-based measurement invariance of Bangla Communication Scale.  Lastly, we assessed item discrimination, item difficulty and precision of BCS using Item Respons Theory Based Analysis
