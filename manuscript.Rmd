...
This study has two objectives: (a) To explore and validate the latent construct of "Bangla Communication Scale" using (b) To gather concurrent validity evidence (c) To increase the precision of the scale usining Item Response Theory guided analysis
## Methods
