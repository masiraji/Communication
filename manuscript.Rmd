...
# Parallel analysis
Horn <- paran(mat=correlations$rho, iterations=500, centile=0, quietly=FALSE,
           status=TRUE, all=FALSE, cfa=TRUE, graph=TRUE,
           color=TRUE, col=c("black","red","blue"),
           lty=c(1,2,3), lwd=1, legend=TRUE, 
           width=640, height=640, grdevice=png, seed=0, n=300)
...
This study had fourth objectives. First, we confirmed the one factor solution of our scale obtained in Study-1 and estimated the reliability of the scale. Second, to gather convergent validity evidence of BCS. For this, we calculated the bivariate correlation among the scores of Bangla Communication Scale and Bangla Hopeless Scale. Third, we established gender-based measurement invariance of Bangla Communication Scale.  Lastly, we assessed item discrimination, item difficulty and precision of BCS using Item Respons eTheory Based Analysis
...
To confirm the latent structure of Bangla Communication scale, we used the one factor solution with 17 items obtained in our Study 1. 
