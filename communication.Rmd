...
```{r data, include=F}
# data <- readxl::read_excel("Processeddata/communication_data_n_622.xlsx")
# readr::write_rds(data, "Processeddata/communication_data_n_622.rds")
...
corplot <- corplot <- ggcorrplot::ggcorrplot(correlations$rho, hc.order = TRUE, outline.col = "white", type = "lower", legend.title = "Correlation",
...
ggsave("Figures/corplot.png",corplot, width = 3.5, height = 3.5, dpi = 600, bg ="white")
...
ggsave("Figures/factors.png",factor, width = 7, height = 3.5, dpi = 600)
```
...
knitr::include_graphics("Figures/factors.png", dpi =600)
...
ggsave("Figures/personfit.jpeg",person , width = 3.5, height = 3.5, dpi = 600, bg = "white")
...
ggsave("Figures/person.png",person , width = 3.5, height = 3.5, dpi = 600, bg = "white")
...
ggsave("Figures/ICC.png",ICC , width = 7, height =7, dpi = 600, bg = "white")
...
ggsave("Figures/TIC.png",test.info , width = 3.5, height = 3.5, dpi = 600, bg = "white")
...
jpeg("Figures/personmap.jpeg", width = 7, height = 7, quality = 100,units="in", res= 1080, pointsize = 12 )
library(WrightMap)
...
ggsave("Figures/itemInfoplot.png",item.info.plot, width = 7, height =7, dpi = 600, bg ="white")
